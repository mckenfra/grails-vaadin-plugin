...
/**
 * Mimics the Grails scaffolding create.gsp
 * <p>
 * Note that the layout can be customised by modifying the HTML
 * in VAADIN/themes/{theme}/layouts/create.html
 * <p>
 * You can also specify a different HTML layout to use, in the constructor
 * 
 * @author Francis McKenzie
 */
class DefaultCreate extends CustomLayout {
    String entityName
    Object instance

    /**
     * Create the layout using the default 'create.html' page
     ...
     */
    public DefaultCreate(String entityName, Object instance) {
        this(entityName, instance, "create")
    }
     ...
     */
    public DefaultCreate(String entityName, Object instance, String layoutName) {
        super(layoutName)
    ...
    protected void buildLayout() {
        // Navigation
        this.navigation = new DefaultNavigation(entityName, ["home", "list"])
        
        // Heading
        this.heading = new Label(message(code:"default.create.label", args:[entityName]), Label.CONTENT_RAW)
    ...
    public void attach() {
        super.attach()
        window.caption = message(code:"default.create.label", args:[entityName])
        showFlash()
    }
     ...
     */
    public Component getHeading() { getComponent("create.label") }
    /**
     * Set the heading label component
     */
    public void setHeading(Component heading) { addComponent(heading, "create.label") }
    /**
    ...
    */
    public Component getBody() { getComponent("create.body") }
    /**
    * Set the body component (the form should be added to this)
    */
    public void setBody(Component body) { addComponent(body, "create.body") }
    /**
