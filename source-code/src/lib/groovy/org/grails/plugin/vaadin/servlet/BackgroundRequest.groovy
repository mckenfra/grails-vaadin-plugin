package org.grails.plugin.vaadin.servlet
...
public class BackgroundRequest implements HttpServletRequest {
    ...
    public BackgroundRequest(Object requestURI, Object servletContext, Object applicationContext, List<Cookie> cookies, HttpSession session = null) {
        ...
        this._session = session ?: new BackgroundSession(servletContext)
