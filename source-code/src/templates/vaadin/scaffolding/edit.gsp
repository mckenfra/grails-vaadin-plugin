...
<v:location name="body">
	...
	<div id="edit-${domainClass.propertyName}" class="content scaffold-edit" role="main">
		...
		<div>
			<v:verticalLayout>
				<v:form var="editForm" bean="\${${propertyName}}" writeThrough="false" invalidCommitted="true">
...
${renderEditor(p)}<%  } %>
	...
	<div class="buttons toolbar">
		<v:horizontalLayout spacing="false">
			<v:link icon="images/skin/database_save.png" action="update" instance="\${${propertyName}}" onclick="\${v.commit(form:'editForm')}"><g:message code="default.button.update.label"/></v:link>
